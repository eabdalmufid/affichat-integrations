...
export class AffiChat implements INodeType {
  ...
  async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
    ...
    for (let i = 0; i < items.length; i++) {
      try {
        ...
        if (resource === "message") {
          ...
          if (operation === "sendText") {
            ...
            body = {
              sessionId,
              to,
              stickerUrl: this.getNodeParameter("stickerUrl", i) as string,
            };
            ...
            body = {
              sessionId,
              to,
              contactName: this.getNodeParameter("contactName", i) as string,
              contactNumber: this.getNodeParameter("contactNumber", i) as string,
            };
          } else if (operation === "sendPoll") {
            endpoint = "/api/send-poll";
            const rawOptions = this.getNodeParameter("pollOptions", i) as string | string[];
            ...
            body = {
              ...
              options,
              multipleAnswers: this.getNodeParameter("multipleAnswers", i, false) as boolean,
            };
          }
          ...
          if (operation === "sendBulk") {
            ...
            const rawRecipients = this.getNodeParameter("recipients", i) as string | string[];
            ...
            body = {
              ...
              delayMs: this.getNodeParameter("delayMs", i, 2000) as number,
            };
          ...
          if (operation === "listGroups") {
            ...
            qs = {
              sessionId,
              include_participants: this.getNodeParameter("includeParticipants", i, false) as boolean,
            };
        ...
        returnData.push({
          json: (responseData && typeof responseData === "object" ? responseData : { response: responseData }) as IDataObject,
          pairedItem: { item: i },
        });
      } catch (error) {
